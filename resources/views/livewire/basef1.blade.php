                    ...
                    <div class="col-sm-12">
                        <div class="popup_content">
                            <div class="popup-text">
                                ...
                                <p>Souscrire à la newsletter pour rester informé sur les nouveaux produits.</p>
                            </div>
                	...
                	<div class="text-center text-md-right">
                       	<ul class="header_list">
                            ...
                            @if(Route::has('login') )
                                ...
                                @else 
                                    {{--<li><a href="/login"><i class="ti-user"></i><span>S'indentifier</span></a></li>--}}
                                    <li><a href="{{route('login')}}"><i class="ti-user"></i><span>S'indentifier</span></a></li>
                                    {{--<li><a href="/signup"><i class="ti-email"></i><span>S'inscrire</span></a></li> --}}       
                                    <li><a href="{{route('signup')}}"><i class="ti-email"></i><span>S'inscrire</span></a></li> 
                                @endif
                            ...
                            <div class="dropdown-menu">
                                <ul class="mega-menu d-lg-flex">
                                            <li class="mega-menu-col col-lg-3">
                                                <ul> 
                                                    <li class="dropdown-header">Vêtements</li>
                                            ...
                                            <li class="mega-menu-col col-lg-3">
                                                <ul>
                                                    ...
                                                    <li><a class="dropdown-item nav-link nav_item" href="/shopproduct-">Bocaux plastiques</a></li>
                                            ...
                                            <li class="mega-menu-col col-lg-3">
                                                <ul>
                                                    ...
                                                    <li><a class="dropdown-item nav-link nav_item" href="/shopproduct-brossetoillette">Brosse de toilette</a></li>
                                ...
                                <div class="d-lg-flex menu_banners">
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="{{ asset('assets/images/peignechauffant2en1-1920x650.jpg') }}" alt="menu_banner1">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="{{ asset('assets/images/menu_banner22.jpg') }}" alt="menu_banner2">
                                            <div class="banne_info">
                                                <h6>15% Off</h6>
                                                <h4>Wooden Chair</h4>
                                                <a href="#">Shop now</a>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="{{ asset('assets/images/menu_banner33.jpg') }}" alt="menu_banner3">
                                            <div class="banne_info">
                                                <h6>23% Off</h6>
                                                <h4>Wooden Chair</h4>
                                                <a href="#">Shop now</a>
...
<div class="banner_section slide_wrap shop_banner_slider staggered-animation-wrap">
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-ride="carousel">
        <div class="carousel-inner">
                    	...
                    	<div class="row">
                            <div class="col-lg-6 col-md-8 col-sm-9 col-10">
                                <div class="banner_content2">
                                    <h6 class="mb-2 mb-sm-3 staggered-animation text-uppercase" data-animation="fadeInDown" data-animation-delay="0.2s"></h6>
                    	...
                    	<div class="row">
                            <div class="col-lg-6 col-md-8 col-sm-9 col-10">
                                <div class="banner_content2">
                                    ...
                                    <h2 class="staggered-animation" data-animation="fadeInDown" data-animation-delay="0.3s">Peigne 2 en 1</h2>
            ...
            <div class="carousel-item background_bg" data-img-src="{{ asset('assets/images/banner-brossetoilette-1920x600.jpg') }}">
                <div class="banner_slide_content banner_content_inner">
                	<div class="container">
                    	<div class="row">
                            <div class="col-lg-6 col-md-8 col-sm-9 col-10">
                                <div class="banner_content2">
                                    <h5 class="mb-2 mb-sm-3 staggered-animation font-weight-light" data-animation="fadeInDown" data-animation-delay="0.2s">Profitez de l'un des meilleurs produits disponible sur le marché</h5>
                                    <h2 class="staggered-animation" data-animation="fadeInDown" data-animation-delay="0.3s">Brosse toillete</h2>
                                    <a class="btn btn-border-fill btn-radius staggered-animation text-uppercase" href="shop-left-sidebar.html" data-animation="fadeInUp" data-animation-delay="0.4s">Acheter maintenant</a>
                                </div>
                            </div>
                        </div>
